...
import Demo from '../Components/Para'
import Products from '../Components/Products'
...
const Home = () => {
  return (
    <div>
      ...
      <Paymentflex/>
      <div style={{boxShadow: "rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px",marginTop:"15px"}}>My Smart Basket</div>
