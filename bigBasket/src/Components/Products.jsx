  ...
  return (
    <Container>
      ...
      <Col >
        ...
        <img onClick={()=>{navigate("/product");}} src="https://www.bigbasket.com/media/uploads/p/s/40072320_2-fresho-farm-eggs-table-tray-medium-antibiotic-residue-free.jpg" alt="" width={"120px"} height={"150px"}/>
      ...
      <Col>
        <div style={{textAlign:"end",color:"#BA5253",fontSize:"10px",border:"1px solid white",boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>GET 37% OFF<span style={{color:"red"}}>*</span></div>
        <img src="https://www.bigbasket.com/media/uploads/p/s/40208261_1-borges-extra-virgin-olive-oil.jpg" alt="" width={"120px"} height={"150px"}/>
        <h6 style={{color:"#99999",fontSize:"5px",textAlign:"start",paddingLeft:"5px"}}>Fresho</h6>
        <a style={{color:"black",textDecoration:"none",fontSize:"9px"}} href="/">Carrot - Orange (Loose)</a>
        <select style={{border:"0.5px solid grey",fontSize:"9px",padding:"0px 15px "}} name="" id="">
          <option value="">1kg -Rs 750</option>
      ...
      <Col>
        <div style={{textAlign:"end",color:"#BA5253",fontSize:"10px",border:"1px solid white",boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>GET 37% OFF<span style={{color:"red"}}>*</span></div>
        <img src="https://www.bigbasket.com/media/uploads/p/s/10000200_17-fresho-tomato-hybrid.jpg" alt="" width={"120px"} height={"150px"}/>
        <h6 style={{color:"#99999",fontSize:"5px",textAlign:"start",paddingLeft:"5px"}}>Fresho</h6>
        <a style={{color:"black",textDecoration:"none",fontSize:"9px"}} href="/">Carrot - Orange (Loose)</a>
        <select style={{border:"0.5px solid grey",fontSize:"9px",padding:"0px 15px "}} name="" id="">
          <option value="">1kg -Rs 750</option>
      ...
      <Col>
        <div style={{textAlign:"end",color:"#BA5253",fontSize:"10px",border:"1px solid white",boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>GET 37% OFF<span style={{color:"red"}}>*</span></div>
        <img src="https://www.bigbasket.com/media/uploads/p/s/240100_9-duracell-ultra-alkaline-battery-aa.jpg" alt="" width={"120px"} height={"150px"}/>
        <h6 style={{color:"#99999",fontSize:"5px",textAlign:"start",paddingLeft:"5px"}}>Fresho</h6>
        <a style={{color:"black",textDecoration:"none",fontSize:"9px"}} href="/">Carrot - Orange (Loose)</a>
        <select style={{border:"0.5px solid grey",fontSize:"9px",padding:"0px 15px "}} name="" id="">
          <option value="">1kg -Rs 750</option>
